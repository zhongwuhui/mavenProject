...
public class parameterEvaluationImpl implements parameterEvaluation {
    ...
    @Override
    public void getcsAdd2(Map<String, String> allRequestParam, ceshiyongEntity ceshiyongEntity) {

        if (allRequestParam.containsKey("userId") && !allRequestParam.get("userId").equals("")) {
            ceshiyongEntity.setUserId(String.valueOf(allRequestParam.get("userId")));
        }
        if (allRequestParam.containsKey("userName") && !allRequestParam.get("userName").equals("")) {
            ceshiyongEntity.setUserName(String.valueOf(allRequestParam.get("userName")));
        }
        if (allRequestParam.containsKey("NumberId") && !allRequestParam.get("NumberId").equals("")) {
            ceshiyongEntity.setNumberId(String.valueOf(allRequestParam.get("NumberId")));
        }
        if (allRequestParam.containsKey("roler") && !allRequestParam.get("roler").equals("")) {
            ceshiyongEntity.setRoler(String.valueOf(allRequestParam.get("roler")));
        }
        if (allRequestParam.containsKey("classMyId") && !allRequestParam.get("classMyId").equals("")) {
            ceshiyongEntity.setClassMyId(String.valueOf(allRequestParam.get("classMyId")));
        }
